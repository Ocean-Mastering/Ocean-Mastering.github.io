...
export const SHOTS = [
  ...
  { id: "turn", label: "The turn", start: 0.76, end: 0.82 },
  { id: "ascent", label: "Ascent", start: 0.82, end: 0.87 },
  { id: "emergence", label: "Breaking the surface", start: 0.87, end: 0.91 },
  { id: "revelation", label: "The ocean revealed", start: 0.91, end: 1 }
];

const REDUCED_MOTION_STATES = [0.03, 0.12, 0.21, 0.31, 0.45, 0.59, 0.71, 0.79, 0.85, 0.895, 0.995];
...
const KEYFRAMES = [
  ...
  { p: 0.9, cameraX: 0, cameraY: -0.55, cameraZ: 4.2, targetX: 0, targetY: 0, targetZ: -15, fov: 47, submersion: 0.82, surfaceAmplitude: 0.4, surfaceDetail: 0.86, surfaceReveal: 0.7, particleDensity: 0.58, particleSpeed: 0.9, shimmer: 1, currentVisibility: 0.35, turbulence: 0.3, coherence: 1, pressure: 0.08, caustic: 1, beam: 0.8, fogDensity: 0.012, exposure: 0.96, clarity: 0.95 },
  { p: 0.915, cameraX: 0, cameraY: 1.4, cameraZ: 8, targetX: 0, targetY: 0, targetZ: -23, fov: 46, submersion: 0.02, surfaceAmplitude: 0.43, surfaceDetail: 0.9, surfaceReveal: 0.88, particleDensity: 0.05, particleSpeed: 0.5, shimmer: 0.12, currentVisibility: 0.04, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0.08, beam: 0.04, fogDensity: 0.006, exposure: 1.02, clarity: 1 },
  { p: 0.94, cameraX: 0, cameraY: 14, cameraZ: 27, targetX: 0, targetY: 0, targetZ: -34, fov: 50, submersion: 0, surfaceAmplitude: 0.48, surfaceDetail: 0.96, surfaceReveal: 0.96, particleDensity: 0, particleSpeed: 0.3, shimmer: 0, currentVisibility: 0, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0, beam: 0, fogDensity: 0.005, exposure: 1.06, clarity: 1 },
  { p: 0.96, cameraX: 0, cameraY: 45, cameraZ: 60, targetX: 0, targetY: 0, targetZ: -34, fov: 55, submersion: 0, surfaceAmplitude: 0.52, surfaceDetail: 1, surfaceReveal: 1, particleDensity: 0, particleSpeed: 0.3, shimmer: 0, currentVisibility: 0, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0, beam: 0, fogDensity: 0.005, exposure: 1.08, clarity: 1 },
  { p: 0.975, cameraX: 0, cameraY: 90, cameraZ: 102, targetX: 0, targetY: 0, targetZ: -34, fov: 60, submersion: 0, surfaceAmplitude: 0.55, surfaceDetail: 1, surfaceReveal: 1, particleDensity: 0, particleSpeed: 0.3, shimmer: 0, currentVisibility: 0, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0, beam: 0, fogDensity: 0.005, exposure: 1.1, clarity: 1 },
  { p: 0.987, cameraX: 0, cameraY: 170, cameraZ: 172, targetX: 0, targetY: 0, targetZ: -34, fov: 66, submersion: 0, surfaceAmplitude: 0.58, surfaceDetail: 1, surfaceReveal: 1, particleDensity: 0, particleSpeed: 0.3, shimmer: 0, currentVisibility: 0, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0, beam: 0, fogDensity: 0.005, exposure: 1.11, clarity: 1 },
  { p: 1, cameraX: 0, cameraY: 320, cameraZ: 270, targetX: 0, targetY: 0, targetZ: -34, fov: 72, submersion: 0, surfaceAmplitude: 0.6, surfaceDetail: 1, surfaceReveal: 1, particleDensity: 0, particleSpeed: 0.3, shimmer: 0, currentVisibility: 0, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0, beam: 0, fogDensity: 0.005, exposure: 1.12, clarity: 1 }
];
