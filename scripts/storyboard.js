...
export const SHOTS = [
  ...
  { id: "ascent", label: "Ascent", start: 0.84, end: 0.9 },
  { id: "emergence", label: "Breaking the surface", start: 0.9, end: 0.95 },
  { id: "revelation", label: "Revelation", start: 0.95, end: 1 }
];

const REDUCED_MOTION_STATES = [0.03, 0.12, 0.21, 0.31, 0.45, 0.59, 0.71, 0.8, 0.87, 0.925, 0.995];
...
export const COPY_CUES = [
  ...
  { id: "ascent", start: 0.82, holdStart: 0.85, holdEnd: 0.895, end: 0.935 },
  { id: "finale", start: 0.93, holdStart: 0.952, holdEnd: 1, end: 1 }
];
...
const KEYFRAMES = [
  ...
  { p: 0.955, cameraX: 0, cameraY: 1.4, cameraZ: 8, targetX: 0, targetY: 0, targetZ: -23, fov: 46, submersion: 0.02, surfaceAmplitude: 0.43, surfaceDetail: 0.9, surfaceReveal: 0.88, particleDensity: 0.05, particleSpeed: 0.5, shimmer: 0.12, currentVisibility: 0.04, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0.08, beam: 0.04, fogDensity: 0.006, exposure: 1.02, clarity: 1 },
  { p: 0.97, cameraX: 0, cameraY: 14, cameraZ: 27, targetX: 0, targetY: 0, targetZ: -34, fov: 50, submersion: 0, surfaceAmplitude: 0.48, surfaceDetail: 0.96, surfaceReveal: 0.96, particleDensity: 0, particleSpeed: 0.3, shimmer: 0, currentVisibility: 0, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0, beam: 0, fogDensity: 0.005, exposure: 1.06, clarity: 1 },
  { p: 0.982, cameraX: 0, cameraY: 48, cameraZ: 62, targetX: 0, targetY: 0, targetZ: -34, fov: 55, submersion: 0, surfaceAmplitude: 0.52, surfaceDetail: 1, surfaceReveal: 1, particleDensity: 0, particleSpeed: 0.3, shimmer: 0, currentVisibility: 0, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0, beam: 0, fogDensity: 0.005, exposure: 1.08, clarity: 1 },
  { p: 0.991, cameraX: 0, cameraY: 105, cameraZ: 106, targetX: 0, targetY: 0, targetZ: -34, fov: 60, submersion: 0, surfaceAmplitude: 0.55, surfaceDetail: 1, surfaceReveal: 1, particleDensity: 0, particleSpeed: 0.3, shimmer: 0, currentVisibility: 0, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0, beam: 0, fogDensity: 0.005, exposure: 1.1, clarity: 1 },
  { p: 1, cameraX: 0, cameraY: 190, cameraZ: 160, targetX: 0, targetY: 0, targetZ: -34, fov: 66, submersion: 0, surfaceAmplitude: 0.58, surfaceDetail: 1, surfaceReveal: 1, particleDensity: 0, particleSpeed: 0.3, shimmer: 0, currentVisibility: 0, turbulence: 0.3, coherence: 1, pressure: 0, caustic: 0, beam: 0, fogDensity: 0.005, exposure: 1.12, clarity: 1 }
];
